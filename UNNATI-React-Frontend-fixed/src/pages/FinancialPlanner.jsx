  ...
  return (
    <LegacyPage
      ...
      styles={[
        "/css/dashboard.css",
        "/css/financial.css",
        "/css/financial-planner.css",
        "/css/unnati-assistant.css",
      ]}
      ...
      <>
        <aside className="sidebar">
          <div className="dashboard-logo unnati-brand">
            <img
              alt="Unnati logo"
              className="unnati-logo"
              src="assets/unnati-logo.png"
            />
        ...
        <main className="dashboard-main">
          <header className="dashboard-header">
            <div>
              <p className="welcome-small">FINANCIAL MANAGEMENT</p>
            ...
            <button
              ...
              data-legacy-onclick="window.location.href='financial.html'"
            >
              ← Back to Financials
            </button>
          </header>

          {/* FIXED FINANCIAL TABS */}
          ...
          <section className="planner-intro">
            ...
            <h2>Plan Your Business Finances</h2>

            <p>
              Estimate sales, expenses, profitability and your expected
              financial performance for the next 12 months.
            </p>
          </section>

          <section className="business-context-card">
            <div>
              <span className="planner-label">YOUR BUSINESS</span>

              <h3 id="plannerBusinessName">Your Business</h3>
            ...
            <div className="capital-box">
              ...
              <strong id="plannerCapital">₹0</strong>
            </div>

            <div className="capital-box">
              <span>Funding Required</span>

              <strong id="plannerFundingRequired">₹0</strong>
            </div>
          </section>
          ...
          <section className="planner-grid">
            <div className="planner-card">
              <div className="card-heading">
                ...
                <p>Enter your expected business sales.</p>
              </div>
            ...
            <div className="planner-card summary-card">
              <div className="card-heading">
                ...
                <p>Estimated monthly performance.</p>
              </div>
              ...
              <div className="summary-list">
                ...
                <div className="summary-row">
                  ...
                  <strong id="summaryExpenses">₹0</strong>
                </div>

                <div className="summary-row profit-row">
                  <span>Estimated Net Profit</span>

                  <strong id="summaryProfit">₹0</strong>
                </div>
              ...
              <div className="mini-metrics">
                <div>
                  ...
                  <strong id="summaryBreakEven">₹0</strong>
                </div>

                <div>
                  <span>Contribution Margin</span>

                  <strong id="summaryContribution">0%</strong>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="planner-card">
            <div className="card-heading">
              <h3>Business Financial Health</h3>
            ...
            <div className="health-result">
              ...
              <div>
                ...
                <p id="healthMessage">
                  Calculate your financial plan to see the
          ...
          <section className="planner-card">
            ...
            <div className="forecast-summary">
              <div>
                ...
                <strong id="annualRevenue">₹0</strong>
              </div>

              <div>
                <span>Annual Expenses</span>

                <strong id="annualExpenses">₹0</strong>
              </div>

              <div>
                <span>Annual Profit</span>

                <strong id="annualProfit">₹0</strong>
              </div>
            </div>
